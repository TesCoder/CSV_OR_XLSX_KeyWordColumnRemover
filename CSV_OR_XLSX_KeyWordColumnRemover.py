# This program removes the column that has the words "Currency Code", which can be modified below, from a csv or xlsx & exports xlsx.
# If provided a csv, it first converts it to xlsx.
